...
// Interface for the props of the FormInput component
...
// FormInput component for rendering form input fields
...
const MyComponent: React.FC = () => {
  return (
    <div className="box-border relative overflow-hidden mt-5 w-full min-h-screen">
      ...
      />
      {/* Content container */}
      <div className="box-border absolute inset-0 flex flex-col justify-center px-5 pb-4 mx-auto text-xs" style={{ maxWidth: 1200 }}>
        {/* Header */}
